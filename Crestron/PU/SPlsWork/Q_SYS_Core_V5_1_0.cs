...
namespace UserModule_Q_SYS_CORE_V5_1_0
{
    public class UserModuleClass_Q_SYS_CORE_V5_1_0 : SplusObject
    {
...
public override void LogosSplusInitialize()
{
    ...
    LOGIN_PIN = new StringParameter( LOGIN_PIN__Parameter__, this );
...
public UserModuleClass_Q_SYS_CORE_V5_1_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
